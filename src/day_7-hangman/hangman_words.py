word_list = ["aardvark", "baboon", "camel", "sofa", "district", "disclose", "credibility", "absolute", "prestige",
             "loss", "exemption", "greet", "suffer", "appoint", "suitcase", "coffee", "imposter", "immune", "minute",
             "enemy", "sentiment", "exotic", "housing", "electronics", "folklore", "distribution", "note", "lazy",
             "advantage", "strike", "attack", "serious", "discourage", 'abruptly', 'absurd', 'abyss', 'affix', 'askew',
             'avenue', 'awkward', 'axiom', 'azure', 'bagpipes', 'bandwagon', 'banjo', 'bayou', 'beekeeper', 'bikini',
             'blitz', 'blizzard', 'boggle', 'bookworm', 'boxcar', 'boxful', 'buckaroo', 'buffalo', 'buffoon', 'buxom',
             'buzzard', 'buzzing', 'buzzwords', 'caliph', 'cobweb', 'cockiness', 'croquet', 'crypt', 'curacao', 'cycle',
