...
# Project 2 - Tip Calculator: Ask the user for total bill, tip percentage and number of people, return how much each
# person should pay with a 2 decimal point
...
print(f"Each person should pay:\t${distributed_bill}")
